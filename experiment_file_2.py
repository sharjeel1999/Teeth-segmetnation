...
data_path = 'C:\\Users\\Sharjeel\\Desktop\\codes\\teeth_numbered_data\\problematic_samples.npy'
...
for indd, sample in enumerate(data):
    image, mask, instance, weights, _ = sample #data[3] # 0, 2
